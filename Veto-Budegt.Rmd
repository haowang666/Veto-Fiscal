...
To evaluate the budget-stability hypothesis and punctual equilibrium hypothesis, we create two different dependent variables. The volatility index measures the budget shifts of a certain country at a single time point. We use L-Kurtosis score to measure the degree of punctuations (peakness). 
...
## Veto Player (Institutional Constraints)
We use two measurements of institutional constriants: POLCON index and 



## Decentralization

modeled by regional power index


## Information Processing 

modeled by levels of consulation and engagement


## Corruption and Election Irregularity


## Other Controls
Education, GDP, GDP grow rate, 


# Method and Results
GSRE dataset contain lots of missing data, we did 5 multiple imputations and report results of the original dependent variable as well as the 5 imputed ones. 
...
Table \ref{twoways} reports twoway fixed effect result, as a robustness check.

[@BeckKatz1995], [@BeckKatz2011]
...
plm0 <- lm(stability_0 ~  lag.stability_0 +
             ...
             e_peginiwi +  e_Civil_War , 
               data = mydata)

plm1 <- lm(stability_1 ~  lag.stability_1 +
             e_h_polcon5 +  v2xps_party +
             v2dlconslt + 
             v2x_feduni + 
             v2x_corr + 
...
plm2 <- lm(stability_2 ~  lag.stability_2 +
             e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
...
plm3 <- lm(stability_3 ~  lag.stability_3 +
             e_h_polcon5 +  v2xps_party +
             v2dlconslt + 
             v2x_feduni + 
             v2x_corr + 
...
plm4 <- lm(stability_4 ~  lag.stability_4 +
             e_h_polcon5 +  v2xps_party +
             v2dlconslt + 
             v2x_feduni + 
             v2x_corr + 
...
plm5 <- lm(stability_5 ~  lag.stability_5 +
             e_h_polcon5 +  v2xps_party +
             v2dlconslt + 
             v2x_feduni + 
             v2x_corr + 
...
#----------------------------------------------------------------
lm0 <- lm(y_lk0 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
             ...
             e_peginiwi +  e_Civil_War, 
               data=d)
lm1 <- lm(y_lk1 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
             ...
             e_peginiwi +  e_Civil_War, 
               data=d)
lm2 <- lm(y_lk2 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
             ...
             e_peginiwi +  e_Civil_War, 
               data=d)
lm3 <- lm(y_lk3 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
             ...
             e_peginiwi +  e_Civil_War, 
               data=d)
lm4 <- lm(y_lk4 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
             ...
             e_peginiwi +  e_Civil_War, 
               data = d)
lm5 <- lm(y_lk5 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
tmodel0 <- plm(stability_0 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
tmodel1 <- plm(stability_1 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
tmodel2 <- plm(stability_2 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
tmodel3 <- plm(stability_3 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
tmodel4 <- plm(stability_4 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
tmodel5 <- plm(stability_5 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
