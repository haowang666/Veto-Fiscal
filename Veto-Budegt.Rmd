...
budget <- select(mydata, expend_security_EXP: owelfarespend_GDPGSRE)
stargazer(budget, title = "Components of Budget Stability Measurements", header = FALSE, digits = 3)
```
...
#select GSRE
GSRE <- select(mydata, cowcode, year, c(56:66), c(67:77))
