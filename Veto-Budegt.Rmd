...
Both the first steps and the second steps can influence the final budget outcomes. The information collection can be inefficient and prone to erroreous messages. In a complex environment like politics, it is harder for politicians to decifer signals from the noise. Consequently, inefficient information gathering may lead to inefficient policy decisions. On the other hand, decisions are also bounded by institutional constraints. 'The detection and interpretation of signals may be limited by the system’s structure – incentives, for example, that encourage focusing on internal dynamics, such as bureaucratic infighting rather than problem solving' [@Faganetal2017, p.3]. 
...
Institutional Constraints lead to more stable budget policies. 
...
Veto player $\Rightarrow$ unable to change policy rapidly $\Rightarrow$ long term incremental changes and short-term rapid changes $\Rightarrow$ punctual equilibrium [@DerekBaumgartner2016; @KeeferStasavage2003].
