...
We two major independent variables: 
...
\begin{equation}
S_{jt} = \beta_0 + \beta_{1} S_{jt-1} + \beta_{2} Cont_{jt} + \beta_{3}Party_{jt} + \beta_{4} Corrupt_{jt} +\mathbf{Z} \beta +\epsilon_{jt}
(\#eq:pooled)
\end{equation}
...
\begin{equation}
S_{jt} = a_i + \beta_{2} Cont_{jt} + \beta_{3}Party_{jt} + \beta_{4} Corrupt_{jt} +
...
pmodel0 <- plm(stability_0 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
pmodel1 <- plm(stability_1 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
pmodel2 <- plm(stability_2 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
pmodel3 <- plm(stability_3 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
pmodel4 <- plm(stability_4 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
pmodel5 <- plm(stability_5 ~ e_h_polcon5 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
\begin{equation}
S_{jt} = a_i  + \lambda_t + \beta_{2} Cont_{jt} + \beta_{3}Party_{jt} + \beta_{4} Corrupt_{jt} + \mathbf{Z} \beta +\epsilon_{jt}
(\#eq:twoways)
\end{equation}
...
tmodel0 <- plm(stability_0 ~ e_h_polcon3 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
tmodel1 <- plm(stability_1 ~ e_h_polcon3 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
tmodel2 <- plm(stability_2 ~ e_h_polcon3 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
tmodel3 <- plm(stability_3 ~ e_h_polcon3 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
tmodel4 <- plm(stability_4 ~ e_h_polcon3 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
tmodel5 <- plm(stability_5 ~ e_h_polcon3 +  v2xps_party +
             v2dlconslt +
             v2x_feduni + 
             v2x_corr + 
             polity+ 
...
stargazer(tmodel0, tmodel1, tmodel2, tmodel3, tmodel4, tmodel5, header = FALSE, 
          title = "Two Way Fixed Effect Regression Results", label = "twoways",
          omit = c("e_Civil_War", "e_migdpgro"), 
          dep.var.labels.include = FALSE,
          covariate.labels = c("Constraints", "Party", "Consult", 
                               "Federalism", "Corruption", "Polity", "Censorship",
