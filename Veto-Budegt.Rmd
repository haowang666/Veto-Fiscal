...
tmodel0 <- plm(stability_0 ~ 
                 ...
                 e_migdpgro +
                 e_Civil_War, 
                 data = mydata3, index = c("cowcode", "year"), na.action = na.omit, model = "within", effect = "twoways")
...
GSRE does not include OECD countries by default, we select the remaining countries based on two indicators: the political contraint index and the polity score. We drop countries of which either score does not change in the time period between 1960 and 2006. Countries like China, Vietnam, Sudan, Yemen,  Saudi Arabia etc. are classfied as stable authoritarian regimes and they are dropped from the total observations. 
...
```{r, echo=FALSE, warning=FALSE, fig.cap="Dependent Variables Comparison"}
