...
newdata1 <- filter(rawp, expend_security_EXP >1)
newdata2 <- filter(rawp, wagessalaries_EXP >1)
newdata3 <- filter(rawp, total_welfare_EXP >1)
...
# Multiple Imputation : based on percentage
```{r, include=FALSE}
library(dplyr)
library(Amelia)
...
# Multiple imputation: based on actual expenditure
